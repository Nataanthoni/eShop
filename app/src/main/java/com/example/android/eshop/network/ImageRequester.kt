package com.example.android.eshop.network
...
import com.example.android.eshop.application.EshopApplication

/**
 * Class that handles image requests using Volley.
 */

const val HEIGHT_PIXELS = 4
const val SCREEN_BYTES = 3
...
object ImageRequester {
    ...
    init {
        val context = EshopApplication.instance
    ...
    private fun calculateMaxByteSize(context: Context): Int {
        ...
        val screenBytes = displayMetrics.widthPixels * displayMetrics.heightPixels * HEIGHT_PIXELS
        return screenBytes * SCREEN_BYTES
    }
}
