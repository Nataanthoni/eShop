...
class ProductGridFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val largePadding = resources.getDimensionPixelSize(R.dimen.es_product_grid_spacing)
        val smallPadding = resources.getDimensionPixelSize(R.dimen.es_product_grid_spacing_small)
